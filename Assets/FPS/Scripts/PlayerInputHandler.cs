...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    public Vector3 GetMoveInput()
    {
        if (CanProcessInput())
        {
            Vector3 move = new Vector3(Input.GetAxisRaw(GameConstants.k_AxisNameHorizontal)+hor, 0f, Input.GetAxisRaw(GameConstants.k_AxisNameVertical)+ver);
    ...
    public bool GetFireInputDown_origin()
    {
        return GetFireInputHeld_origin() && !m_FireInputWasHeld;
    }

    public bool GetFireInputReleased_origin()
    {
        return !GetFireInputHeld_origin() && m_FireInputWasHeld;
    }

    public bool GetFireInputHeld_origin()
    {
        if (CanProcessInput())
        {
